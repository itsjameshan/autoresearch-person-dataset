...
**Python path:** Always use this Python:
```
PYTHON=/Users/jameshan/anaconda3/envs/ultralytics_object/bin/python
```
All commands below use `$PYTHON` or the full path. Do NOT use system `python3`.
...
AUTONOMOUS LOOP (max 20 experiments per session):
  ...
  4. Run: /Users/jameshan/anaconda3/envs/ultralytics_object/bin/python train.py > run.log 2>&1
...
- Run command: `/Users/jameshan/anaconda3/envs/ultralytics_object/bin/python train.py > run.log 2>&1` (no tee, keep context clean)
