...
"""Restore test set with proper image-label matching."""
...
# Get images that have matching labels
...
print(f"Total labeled images available: {len(all_images)}")
...
# Copy with exact same filenames
